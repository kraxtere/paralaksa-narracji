---
id: 2026-09-22-fort-trump
tytul: Nawrocki w wywiadzie dla Bloomberga o stałej bazie USA w Polsce i nazwie „Fort Trump”
status: kandydat
powod_odrzucenia: null
droga: od_wiadomosci        # z naszej bazy: Onet i Ukraińska Prawda 23.09
dziedzina: [bezpieczenstwo, polityka]
forma: dwie_opowiesci       # ta sama wypowiedź, ten sam stan wiedzy; różni się to, czy nagłówek zachowuje warunek

fakt:
  czas: null                # wywiad Bloomberg TV 22.09 (wtorek), godzina do ustalenia
  opis: >-
...
relacje:
  - id: r1
    ...
    rola: redakcja
    gatunek: wywiad
    link: https://www.bloomberg.com/news/articles/2026-09-22/if-poland-gets-a-us-base-it-ll-be-called-fort-trump-nawrocki-says
    publikacja: null
    aktualizacja: null
    porownywana_wersja: null
    archiwum: {link: null, wykonano: null}
    naglowek: 'If Poland Gets US Base It’ll Be Called Fort Trump, Nawrocki Says'
    tlumaczenie: 'Jeśli Polska dostanie bazę USA, będzie się nazywać Fort Trump, mówi Nawrocki'
    zostawia_z: 'Warunek („jeśli”) i atrybucja („mówi”).'
    sprawdzil: null          # tytuł z wyników wyszukiwania
  - id: r2
    kraj: PL
    kto: Notes from Poland
    rola: redakcja
    gatunek: wiadomosc
    link: https://notesfrompoland.com/2026/09/23/new-us-fort-trump-military-base-in-poland-confirmed-says-president-nawrocki/
    publikacja: '2026-09-23T09:35+00:00'   # datePublished w kopii Wayback
    aktualizacja: null
    porownywana_wersja: 'kopia 2026-09-23 14:37 UTC'
    archiwum: {link: 'https://web.archive.org/web/20260923143735/https://notesfrompoland.com/2026/09/23/new-us-fort-trump-military-base-in-poland-confirmed-says-president-nawrocki/', wykonano: '2026-09-23T14:37Z'}
    naglowek: 'New US "Fort Trump" military base in Poland "confirmed", says President Nawrocki'
    tlumaczenie: 'Nowa baza USA „Fort Trump” w Polsce „potwierdzona”, mówi prezydent Nawrocki'
    zostawia_z: '„Potwierdzona” (w cudzysłowie, słowa prezydenta) zamiast „jeśli”.'
    sprawdzil: null          # tytuł z wyników wyszukiwania
  - id: r3
    kraj: UA
    ...
    rola: redakcja
    gatunek: wiadomosc
    link: https://www.pravda.com.ua/news/2026/09/23/8054676/
  ...
  - id: r4
    ...
    rola: redakcja
    gatunek: wiadomosc
    link: https://wiadomosci.onet.pl/kraj/karol-nawrocki-o-stalej-bazie-usa-w-polsce-powinna-sie-nazwac-fort-trump/vy0s8q9
  ...
  - id: r5
    ...
    rola: redakcja
    gatunek: wiadomosc
    link: https://tvpworld.com/95537904/nawrocki-fort-trump-us-base-in-poland-is-just-a-question-of-time
    publikacja: null
    aktualizacja: null
    porownywana_wersja: null
...
kontrasty:
  - miedzy: [r1, r2]
    rodzaj: dobor_slow
    opis: 'Bloomberg: „jeśli Polska dostanie bazę”. Notes from Poland: baza „potwierdzona”. Oba nagłówki streszczają ten sam wywiad.'
    zastrzezenia: '„Confirmed” to słowa Nawrockiego w cudzysłowie, nie zmyślenie redakcji. Kontrast dotyczy tego, który fragment wypowiedzi trafił do nagłówka. Decyzji USA brak.'
  - miedzy: [r3, r6]
...
zagadkę („zaproponował nazwę”) albo kontekst zagrożenia (Fox, śmigłowiec). Dobry materiał do formy „Miarka 15 słów” z `docs/FORMY_ODCINKA.md`.

## Hipoteza odbioru
Od „jeśli” do „potwierdzona” jest różnica między planem a faktem. Widz może pytać: czy baza już jest?

## Ilustracja
Tabliczka „Fort Trump” na pustej działce z rusztowaniem i znakiem zapytania. Bez żołnierzy i sprzętu.
